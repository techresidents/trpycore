...
def exec_daemon(path, args, umask=None, working_directory=None):
    ...
    if pid == 0:
        ...
        daemon_pid = execv_daemon(path, args, umask, working_directory)
...
def execv_daemon(path, args, umask=None, working_directory=None):
